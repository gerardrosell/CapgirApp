...
public class ParticipantsListActivity extends AppCompatActivity {
    ...
    private String mes2;
    private String llista="Assistents:\n";
    ...
    protected void onStart(){
        ...
        super.onStart();
        titol.setText(R.string.Participants);
    ...
    public void send_list(View view) {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Llista d'assistents - "+nombreEvento+" - "+dia+"/"+mes2+"/"+año);
